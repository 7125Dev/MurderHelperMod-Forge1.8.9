...
public class ModConfig {
    ...
    // ==================== 角色检测 ====================
    public int roleSlotIndex = 0; // 默认槽位1，索引为0
    ...
    public void load(File configFile) {
        ...
        // 加载角色检测配置
        roleSlotIndex = config.getInt("roleSlotIndex", "general", 0, 0, 8, 
            "Role detection slot index (0-8, represents hotbar slots 1-9)");
    ...
    public void save() {
        ...
        // 保存角色检测配置
        config.get("general", "roleSlotIndex", 0).set(roleSlotIndex);
